	...
	*/
	...
	class Muzzles
	{
		items[] = {
				...
				{ { "muzzle_snds_H", "item" }, 20 },
				{ { "muzzle_snds_M", "item" }, 20 },
				{ { "muzzle_snds_L", "item" }, 20 },
	...
	class Shipwreak
	{
		items[] = {
				...
				{ { "ItemGoldBar10oz", "magazine" }, 5 },
				{ { "ItemGoldBar", "magazine" }, 30 },
				{ { "PartOreGold", "magazine" }, 40 },
		};
	};
	class Gems
	{
		items[] = {
				{ { "ItemJade", "magazine" }, 5 },
				{ { "ItemRuby", "magazine" }, 5 },
				{ { "ItemSapphire", "magazine" }, 5 },
				{ { "ItemTopaz", "magazine" }, 5 },
				{ { "ItemOnyx", "magazine" }, 5 },
				{ { "ItemAmethyst", "magazine" }, 20 },
				{ { "ItemEmerald", "magazine" }, 20 },
				{ { "ItemCitrine", "magazine" }, 20 },
				{ { "ItemGarnet", "magazine" },  30},
		};
	};
	class Mine
	{
